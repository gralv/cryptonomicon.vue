...
//     }
  ...
  methods:{
    subscribeToUpdates(tickerName){
      setInterval( async ()=>{
        const f = await fetch(`https://min-api.cryptocompare.com/data/price?fsym=${tickerName}&tsyms=USD&api_key=96c59cb0f935b4ce170eca18cca65ec9d791c07cf8a9c8d8170a3480702de0cd`)
